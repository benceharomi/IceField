...
//Explorert kirajzolo osztaly
public class ExplorerView extends CharacterView {
    private Explorer ownChar;
    private ImageIcon imageIcon;

    /**
     * konstruktor ami beallitja a kepet noveli a karakterek szamat majd hozzaadja magat a viewcollection-hez
     * @param ex explorer amit kirajzol
     */
    public ExplorerView(Explorer ex){
    ...
    public void addTexture() {
        texture = TextureCollection.instance().getTexture(Textures.EXPLORER);
    }
