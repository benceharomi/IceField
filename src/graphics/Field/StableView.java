...
/**
 * Stabil mezot kirajzolo osztaly
 */
public class StableView extends graphics.field.FieldView {

    /**
     * konstruktor  ami beallitja a label-t valamint hozzaadja magat a viewcollection-hez
     * @param s stabil mezo amit kirajzol
     */
    public StableView(Stable s) {
        ownField = s;
        this.setVisible(true);
        this.setPreferredSize(new Dimension(160, 160));
        this.setFocusable(false);
        this.setBackground(new Color(120, 0, 0, 0));
    ...
    public void addTexture() {
        texture = TextureCollection.instance().getTexture(Textures.STABLE);
    }
}
